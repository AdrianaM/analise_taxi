...
## As viagens que deixam os passageiros no quadrante tem um desivo padrão menor, pois provavelmente as pessoas estão ficando na Penn Station (local bem no centro do quadrante) 
...
df_dropoff_dentroquadr_sample %>%
  plot_ly(x=~trip_duration,type="histogram") %>%
  layout(barmode = "overlay",xaxis=list(range=c(0,1000)))
