...
plot(hour_quarter_freq, type = "o", main="Gráfico de linha temporal por quartos de hora", xlab="Quarto de hora", ylab="Número de viagens")
```
```{r}
df %>%
...
plot(month_freq, type = "o", main="Gráfico de linha temporal mensal", xlab="Mês", ylab="Número de viagens")
```
